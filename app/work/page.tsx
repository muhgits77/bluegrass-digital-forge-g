  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-12">
      <div className="max-w-2xl mb-8">
        ...
        <p className="mt-2 text-[14.5px] text-[#c8cfd3]">Food truck demos like Smoky Wheels lead with the biggest perk — easy on-the-fly “Where We Are Today” location updates from a simple mobile dashboard so owners can change daily spots, festivals, and hours in seconds while they’re on the road.</p>
      </div>
      ...
      <div className="mt-12 text-center border-t border-[#1a2225] pt-9">
        ...
        <p className="mt-1 text-[13.5px] text-[#8a9599]">Food trucks get special attention to the lead benefit: simple mobile dashboard for real-time “Where We Are Today” updates plus festival calendar, online ordering, beautiful food photos, and menu updates — all changeable in seconds from the truck.</p>
