  ...
  return (
    <div className="mx-auto max-w-4xl px-5 py-12">
      ...
      <div className="prose prose-invert mt-5 max-w-none text-[#c8cfd3] text-[15.5px] leading-relaxed">
        ...
        <p className="mt-3">For food truck owners, that means leading with the biggest perk: a simple mobile dashboard so you can change “Where We Are Today” for daily spots, festivals, and events in seconds — plus festival calendar, online ordering, beautiful food photos, and menu updates — whether you’re in Monticello or serving the Charleston waterfront, Battery, or Lowcountry markets.</p>
