...
const DEFAULT_DEMOS: Demo[] = [
  {
    ...
    description: "Warm, appetizing steakhouse website with digital menu and reservations.",
  ...
  },
  {
    ...
    description: "Bold BBQ food truck website with live schedule and online ordering.",
  ...
  },
  {
    ...
    description: "Vibrant taqueria website with colorful menu, catering, and contact.",
